...
function submit() {
  ...
  for (let i = 1; i <= 25; i++) {
    const wrd = document.getElementById(`character${i}`).innerText;
    if (wrd === "") {
  ...
  for (let i = 1; i <= 25; i++) {
    const wrd = document.getElementById(`character${i}`).innerText;
    if (i <= 5) word1 += wrd;
    else if (i <= 10) word2 += wrd;
    else if (i <= 15) word3 += wrd;
    else if (i <= 20) word4 += wrd;
    else if (i <= 25) word5 += wrd;
  }
  array2.push(word1, word2, word3, word4, word5);

  let word6 = "", word7 = "", word8 = "", word9 = "", word10 = "";
  for (let i = 1; i <= 5; i++) {
    word6 += document.getElementById(`character${i}`).innerText;
    word7 += document.getElementById(`character${i + 1}`).innerText;
    word8 += document.getElementById(`character${i + 2}`).innerText;
    word9 += document.getElementById(`character${i + 3}`).innerText;
    word10 += document.getElementById(`character${i + 4}`).innerText;
  }
  array2.push(word6, word7, word8, word9, word10);

  for (let i = 0; i < array2.length; i++) {
    const arrayword = array2[i].toLowerCase();
    if (WORDS.includes(arrayword)) {
...
function saveBestTimes() {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    const time = parseInt(timeText.split(':')[1].trim());
    times[id] = time;
  }
  localStorage.setItem('bestTimes', JSON.stringify(times));
}

// the array of words used for the game
let WORDS = [
    'which',
    'there',
    'their',
